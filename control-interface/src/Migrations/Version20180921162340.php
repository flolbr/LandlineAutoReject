 ...
 */
final class Version20180921162340 extends AbstractMigration
{
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE number (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, number VARCHAR(15) NOT NULL COLLATE BINARY, note VARCHAR(255) DEFAULT NULL COLLATE BINARY, added DATETIME NOT NULL)');
