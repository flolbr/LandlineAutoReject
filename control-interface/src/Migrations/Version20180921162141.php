 ...
 */
final class Version20180921162141 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE call (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, caller_id INTEGER NOT NULL, time DATETIME NOT NULL, CONSTRAINT FK_CC8E2F3EA5626C52 FOREIGN KEY (caller_id) REFERENCES number (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
